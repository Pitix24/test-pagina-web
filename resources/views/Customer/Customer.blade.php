                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <a href="{{ url('/clientes/export') }}" class="btn btn-primary">
                                <i class="ti ti-file-export me-1"></i> Exportar Clientes
                            </a>
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header modal-colored-header bg-success text-white">
                        <h4 class="modal-title text-white" id="success-header-modalLabel">Clientes</h4>
