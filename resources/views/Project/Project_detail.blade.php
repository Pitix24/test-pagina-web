...
<div class="">
    <div class="container-fluid p-0" style="background-color: #011f25;">
        <center>
            {{-- <lite-youtube videoid="{{ $Project->video_1 }}"
                poster="../../resource/1744841889_68002ca137b9aportada_youtube.png" style="width: 45%; height: 350px;"
                autopause title="Play: Video">
            </lite-youtube> --}}
    ...
    <div class="row text-center">
        ...
        <div class="col-md-4 mb-4">
            <div class="rounded-circle  mx-auto"
                ...
                <img src="../../resource/1739199924_67aa15b4ae38bterreno.svg" alt="Placeholder" width="" class=""
                    style="margin:-15px">
            </div>
        ...
        <div id="carouselExampleControls" class="carousel slide d-md-block d-lg-none" data-bs-ride="carousel"
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <div class="card mx-auto text-center" style="width: 18rem;">
                        <div class="card-body">
                            <img src="../../resource/1739200195_67aa16c37f409juegos%20para%20ni%C3%B1os.svg"
                                width="100%" style="padding-left:40px;padding-right:40px" alt="" srcset="">
        ...
        <div class="container d-none d-lg-block mt-4">
            <div class="row text-center d-flex justify-content-center">
                <div class="col-lg-3 col-xl-2 mb-0">
                    <div class=" card border-0 ">
                        <div class="card-body justify-content-center">
                            <img src="../../resource/1739200178_67aa16b20b63coportunidad%20de%20inversion.svg"
                                width="100%" style="" alt="" srcset="">
                ...
                <div class="col-lg-3 col-xl-2 mb-0">
                    <div class=" card border-0 ">
                        <div class="card-body">
                            <img src="../resource/1739200186_67aa16ba641eaportico.svg" width="100%" style="" alt=""
                                srcset="">
    ...
    <div style=" color: white;">
        ...
        <div id="bootstrapCarousel" class="py-3 carousel slide" data-bs-ride="carousel" data-bs-interval="30000">
            ...
            <div class="carousel-indicators mb-3">
                ...
                @for ($i = 1; $i <= 10; $i +=2) @php $video_1='video_' . $i; $video_2='video_' . ($i + 1); @endphp @if
                    (!empty($Project->$video_1) || !empty($Project->$video_2))
                    <button type="button" data-bs-target="#bootstrapCarousel" data-bs-slide-to="{{ $totalSlides }}"
                        ...
                        aria-label="Diapositiva {{ $totalSlides + 1 }}" style="background-color: transparent;
...
<div class="container py-1">
    ...
    <div class="mt-4 row g-4 text-center align-content-center justify-content-center">
        <!-- Card 1 -->
        @for ($i = 1; $i <= 10; $i++) @php $tourist_image='tourist_image_' . $i; $tourist='tourist_' . $i; @endphp @if
            ($Project->$tourist_image != '')
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="background-color:#054E5C">
                ...
                <div class="modal-body">
                    ...
                    <!-- CARD 1: Formulario -->
                    <div id="formCard" class="p-3 rounded"
                        style="background-color: #055261; color: white; box-shadow: 0px 10px 10px rgba(0, 0, 0, 0.3);">
                        <div id="formContainer">
                            <p class="text-center text-light mb-4"><b><span style="font-size: 12px;">QUIERO INFORMACIÓN
                                        DE UN LOTE</span></b></p>

                            <select class="form-control mb-3" name="project_id" id="project_id"
                            ...
                            <div class="form-check text-start">
                                ...
                                <label class="form-check-label fs-3" for="txtTratamientoDatos">
                                    ...
                                    <a class="text-warning fs-2" data-bs-toggle="modal"
                                        data-bs-target="#bs-example-modal-xlg2" style="cursor: pointer;">Política para
                                        envío de comunicaciones comerciales.</a>
                                </label>
                            </div>
                            ...
                            <div class="form-check text-start">
                                ...
                                <label class="form-check-label fs-3" for="txtTratamientoDatos2">
                                    ...
                                    <a class="text-warning fs-2" data-bs-toggle="modal"
                                        data-bs-target="#bs-example-modal-xlg" style="cursor: pointer;">Tratamiento de
                            ...
                            <div class="text-center mt-3">
                                <button id="submitButton" type="button" class="btn btn-warning"
                                    onclick="CustomerStorePublic();"
                                    style="color: white; border-radius: 100px; background-color: #F6A42C; width: 180px;">
                                    <span id="buttonText" style="font-family: Montserrat-Bold; font-size: 12px;">Enviar
                                        mis datos</span>
                    ...
                    <div id="thankYouCard" class="text-center py-5"
                        style="display: none; background-color: white; border-radius: 15px;">

                        <!-- Paso visual -->
                        <div class="d-flex justify-content-center align-items-center mb-4">
                            <div class="rounded-circle d-flex justify-content-center align-items-center"
                                style="width: 32px; height: 32px; background-color: #e5e5e5; color: #888; font-weight: bold; font-size: 14px;">
                                1</div>
                            <div style="width: 40px; height: 1px; background-color: #ccc; margin: 0 10px;"></div>
                            <div class="rounded-circle d-flex justify-content-center align-items-center"
                                style="width: 32px; height: 32px; background-color: #055261; color: white; font-weight: bold; font-size: 14px;">
                                2</div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="mx-auto d-flex justify-content-center align-items-center"
                                style="width: 72px; height: 72px; background-color: #F6A42C; border-radius: 50%;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="white"
                                    viewBox="0 0 16 16">
                                    <path
                                        d="M13.485 1.929a.75.75 0 0 1 0 1.06L6.06 10.414a.75.75 0 0 1-1.06 0L2.515 7.93a.75.75 0 1 1 1.06-1.06L5.5 8.793l7.424-7.424a.75.75 0 0 1 1.061 0z">
                                    </path>
                                </svg>
                            </div>
                        </div>
                        ...
                        <!-- Mensaje -->
                        <p class="fw-bold" style="font-size: 18px; color: #002b33; margin-bottom: 8px;">¡Gracias por
                            contactarnos!</p>
                        <p style="color: #124653; font-size: 15px; margin-bottom: 0;">Nuestro equipo se
                            comunicará<br>contigo muy pronto.</p>
