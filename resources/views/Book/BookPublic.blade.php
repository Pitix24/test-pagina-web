...
Política para envío de comunicaciones comerciales.
                <div class="row">
                    ...
                    <div class="col-12 row text-center my-3">
                            ...
                            <select name="project" id="project" class="form-control" required
                                ...
                                @foreach ($projects as $project)
                                    ...
                                    <optgroup label="{{ $project->title }}"
                                        ...
                                        @for ($i = 1; $i <= 20; $i++)
                                            @php
                                                $subproject = $project->{'subproject_' . $i};
                                            @endphp
                                            @if (!empty($subproject))
                        ...
                        <input type="text" required style="width:50%" id="manzana_lote" name="manzana_lote" class="form-control" placeholder="Ingrese Manzana / Lote"
                            style="background: rgba(255, 255, 255, 0.1); color: white; border: 1px solid #666464; padding: 12px;font-size:20px">
     ...
     <div class="modal fade" id="bs-example-modal-xlg" tabindex="-1" aria-labelledby="bs-example-modal-lg"
        ...
        <div class="modal-dialog modal-xl">
            ...
            relación contractual, comercial y/o de cualquier índole con <strong>AYBAR S.A.C.</strong> y hasta por 10 años
            ...
            su reglamento y aquellas que las modifiquen o sustituyan, así como las vinculadas a las autoridades que fiscalizan la labor de <strong>AYBAR S.A.C.</strong>
            <br><br>
            ...
            pudiendo dirigir mi solicitud de ejercicio de los derechos a través de la dirección especificada en la página web de <strong>AYBAR S.A.C.</strong>
            o al correo datospersonales@aybarsac.com, llenando el formulario siguiente <a href="https://credilotesperu.com/derechos_arco/FORMATO_DERECHOS_ARCO_AYBAR_CORP.pdf" target="_blank" rel="noopener noreferrer"><strong>LPDP</strong></a>
, teniendo a salvo además el ejercicio de la tutela de sus
            derechos ante la Autoridad Nacional de Protección de Datos Personales en vía de reclamación o ante el Poder Judicial mediante la acción de
            hábeas data.
            <br><br>  Los datos personales recolectados por <strong>AYBAR S.A.C.</strong> son obligatorios, la negativa a suministrarlos supondrá
            la imposibilidad de concretar el fin previsto.
            <br><br>
            <a href="{{ asset('documentos/FORMATO_DERECHOS_ARCO_AYBAR_CORP.pdf') }}" target="_blank"  style="color: #00bfff; text-decoration: none;">
